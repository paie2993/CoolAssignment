...
public class Main {
    ...
    private static int findSadFeeling(final List<Integer> feelings, final int offset) {
    ...
    private static boolean checkNeighbours(final List<Integer> feelings, final int position) {
        validateFeelings(feelings);
    ...
    private static void insertHappyFeelings(final List<Integer> feelings, final int position) {
        validateFeelings(feelings);
        validatePosition(feelings, position);
    ...
    private static List<Integer> beHappy(final List<Integer> feelings) {
